...
def calculate_num_splits(S, untouched_reflectors, tilted_diagram):
    ...
    while(started_beams):
        ...
        for beam in started_beams:
            ...
            # part of the row
            if '^' in tilted_diagram[beam[0]][beam[1]:]:
                next_reflector = (beam[0], tilted_diagram[beam[0]][beam[1]:].index('^')+beam[1])
                if next_reflector not in untouched_reflectors:
                    next_reflector = None
            ...
            if next_reflector:
                ...
                num_splits += 1
                if next_reflector in untouched_reflectors:
